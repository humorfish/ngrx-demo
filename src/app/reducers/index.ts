...
const developmentReducer: ActionReducer<any, any> = compose(storeFreeze, combineReducers)(reducers);
const productionReducer: ActionReducer<any, any> = combineReducers(reducers);
